...
- Create Angular project with ng: `ng new aspnetandangularplace.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`aspnetandangularplace.client.esproj`).
